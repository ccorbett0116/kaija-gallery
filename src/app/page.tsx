      ...
      <main className="min-h-screen bg-slate-950 text-slate-100">
          ...
          <header
              ...
              <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
                  ...
                  {/* Right side: Ideas, Media, Add Date all grouped together */}
                  <div className="flex items-center gap-0">
                      <Link
                          href="/ideas"
                          className="text-sm text-slate-400 hover:text-sky-400 pl-3 pr-0 py-2 leading-none"
                      >
                          Ideas
                      </Link>
                      ...
                      <Link
                          href="/media"
                          className="text-sm text-slate-400 hover:text-sky-400 pl-3 pr-2 py-2 leading-none"
                      >
                          Media Gallery
                      </Link>
                      ...
                      <Link
                          href="/dates/new"
                          className="inline-flex items-center justify-center rounded-md bg-sky-600 px-3 py-2 text-sm font-medium hover:bg-sky-500"
                      >
                          Add Date
                      </Link>
                  </div>
